...
sudo -u $1 pikaur -S --noconfirm --needed mpv gnome-shell-extension-appindicator-git gnome-shell-extension-caffeine-git gnome-shell-extension-clipboard-indicator-git gnome-shell-extension-freon-git
